#支援なしの軌跡データのグラフ化のために使用(カルマンフィルタによるノイズ除去なし)
...
file_path = '/home/toyoshima/script/hand_detection/exp_no_support/kondo/traj_time/traj_time_20240118_174347_9.npy'
...
plt.plot(T,y, 'o', color='black', linewidth=1.0, label='off')
...
fig = plt.gcf()
canvas = fig.canvas
canvas.set_window_title('kondo_1_off')
plt.xlabel('T')
plt.ylabel('X')
plt.grid(True)
plt.legend()
