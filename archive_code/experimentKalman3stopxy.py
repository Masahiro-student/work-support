...
def toward_tool(start_time, count, r):
    ...
    while flag:
        ...
        #print(deltax)
        #print(previous_x[0] - x[0])
        print(previous_x[3] , x[3])
        #print(deltax)
        ...
        if deltax < 5:
            ...
            trajectory_predict.append([hand.center[0],hand.center[1]])
            search_object(line_in_object2(object_polygon, [center[0],center[1]], [hand.center[0],hand.center[1]]))
            for i in [1,2,4,5]:
                x[i]  = 0
                xm1[i] = 0
    ...
    np.save('/home/toyoshima/trajectory.npy', observation)
    np.save('/home/toyoshima/object_polygon.npy', object_polygon)
    ...
    plt.plot(T,tp[:,1], '*',color='blue',label='Prediction')
