...
def toward_tool(start_time, count, r):
    ...
    while flag:
        ...
        #xm1, Pm1, h_pred3 = klf.kalman_filter(xm1, Pm1, np.array(center0))
        #xm2, Pm2, h_pred3 = klf.kalman_filter(xm2, Pm2, np.array(center1))
        ...
        #print(line_in_object2(object_polygon, center0, center1))
