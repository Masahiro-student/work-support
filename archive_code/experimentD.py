...
def toward_tool(start_time, count, r):
    ...
    while flag:
        ...
        t2 = tt2
        #print(dt2)
        draw_marker_direction2(color_arr,hand.center,center)
        ...
        #print(line_in_object2(object_polygon, hand.center, center))
        search_object(line_in_object2(object_polygon, hand.center, center))
        #mc.send_pwm(3,200)
        #wall(hand)
        #guide2(hand, target)
        draw_marker(color_arr, marker)
