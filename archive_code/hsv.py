...
# 対象画像読み込み
img = cv2.imread("/home/toyoshima/script/0001.png",cv2.IMREAD_COLOR)

# 対象範囲を切り出し
boxFromX = 549 #対象範囲開始位置 X座標
boxFromY = 552 #対象範囲開始位置 Y座標
boxToX = 559 #対象範囲終了位置 X座標
boxToY = 562 #対象範囲終了位置 Y座標
# y:y+h, x:x+w　の順で設定
